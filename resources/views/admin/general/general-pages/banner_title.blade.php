<div class="row">
    <div class="col-lg-12">
        <div class="card">
            ...
            @endif
            <div class="card-body">
                <form class="form-horizontal" action="{{ route('store.banner.title') }}" enctype="multipart/form-data"
                    method="POST">
                    @csrf
                    <div class="form-group">
                        <label>Title</label>
                        <input type="text" class="form-control" rows="5" name="title" id="name"
                            placeholder="Title">
                    </div>
                    <div class="form-group">
                        <label>Image</label>
                ...
                <tbody>
                    @foreach ($banner_titles as $data)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('edit.banner.title', ['id' => $data->id]) }}"
