                    ...
                    <div class="d-flex align-items-start">
                        <div class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist"
                            ...
                            <button class="nav-link active" id="v-pills-home-tab" data-bs-toggle="pill"
                                data-bs-target="#v-pills-banner-title" type="button" role="tab"
                                aria-controls="v-pills-home" aria-selected="true">Page Banner and Title</button>
                            ...
                            <button class="nav-link" id="v-pills-messages-tab" data-bs-toggle="pill"
                                ...
                                aria-controls="v-pills-messages" aria-selected="false">Website Links</button>
                            <button class="nav-link" id="v-pills-settings-tab" data-bs-toggle="pill"
                                data-bs-target="#v-pills-banner" type="button" role="tab"
                                aria-controls="v-pills-settings" aria-selected="false">Website Banner</button>
                            <button class="nav-link" id="v-pills-settings-tab" data-bs-toggle="pill"
                                data-bs-target="#v-pills-counter" type="button" role="tab"
                                aria-controls="v-pills-settings" aria-selected="false">Website Counter</button>
                            <button class="nav-link" id="v-pills-settings-tab" data-bs-toggle="pill"
                        ...
                        <div class="w-75 mx-auto">
                            <div class="tab-content" id="v-pills-tabContent">
                                <div class="tab-pane fade show active" id="v-pills-banner-title" role="tabpanel"
